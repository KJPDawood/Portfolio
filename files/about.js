...
color1.addEventListener("click",function () {
    ...
    root.style.setProperty("--boxShadow" ,"0 0 15px rgba(255, 0, 0)");
});
color2.addEventListener("click",function () {
    ...
    root.style.setProperty("--boxShadow" ,"0 0 15px rgb(0, 255, 0)");
});
color3.addEventListener("click",function () {
    ...
    root.style.setProperty("--boxShadow" ,"0 0 15px rgb(0, 174, 255)");
});
color4.addEventListener("click",function () {
    ...
    root.style.setProperty("--boxShadow" ,"0 0 15px rgb(255, 255, 0)");
});
color5.addEventListener("click",function () {
    ...
    root.style.setProperty("--boxShadow" ,"0 0 15px rgb(255, 166, 0)");
});